...
#region Core UI Functions
        ...
        function Register-UIEventHandlers
        {
            ...
            #region Step: Register Defined Event Handlers for Each UI Element
                ...
                foreach ($elementName in $eventMappings.Keys)
                {
                    ...
                    if ($element)
                    {
                        foreach ($event in $eventMappings[$elementName].Keys)
                        {
                            # Create a unique source identifier for each event subscription.
                            $sourceIdentifier = "EntropiaDashboard.$elementName.$event"
                            ...
                            Register-ObjectEvent -InputObject $element `
                                -EventName $event `
                                -Action $eventMappings[$elementName][$event] `
    ...
    #region Function: Set-UIElement
        function Set-UIElement
        {
            ...
            .PARAMETER type
                [string] The type of UI element to create. Valid values: 'Form', 'Panel', 'Button', 'Label', 'DataGridView', 'TextBox', 'ComboBox'. (Mandatory)
            .PARAMETER visible
            ...
            param(
                ...
                [ValidateSet('Form', 'Panel', 'Button', 'Label', 'DataGridView', 'TextBox', 'ComboBox')]
                [string]$type,
                [bool]$visible,
                [int]$width,
                [int]$height,
