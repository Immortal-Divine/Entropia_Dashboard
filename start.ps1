<# start.ps1
	...
	.NOTES
		...
		Version: 2.4
		Requires: PowerShell 5.1+, .NET Framework 4.6.2+, Administrator privileges, Bypassed 32-bit PowerShell execution.
...
function Write-Verbose
{
	...
	if ($VerbosePreference -eq 'Continue')
	{
		...
		{
			if ($null -eq $global:LogWriter -or $global:LogWriterPath -ne $logPath)
			{
				try
				{
					if ($global:LogWriter) { $global:LogWriter.Dispose(); $global:LogWriter = $null }
					...
					$sw.AutoFlush = $true
					$global:LogWriter = [System.IO.TextWriter]::Synchronized($sw)
					$global:LogWriterPath = $logPath
				}
				catch {}
			}
			if ($global:LogWriter)
			{
				try { $global:LogWriter.WriteLine($logLine) } catch {}
			}
		}
...
$global:DashboardConfig = @{
	Paths            = @{
		...
		Bosses   = Join-Path $env:APPDATA 'Entropia_Dashboard\Bosses'
	...
	DefaultConfig    			= [ordered]@{
		...
		'Options'           	= [ordered]@{ 'GuideSeen' = '0'; 'SelectedProfile' = ''; 'WorldBossListener' = '0'; 'AccessCode' = 'TEST'; 'ShowBossImages' = '0'; 'LauncherTimeout' = '60' }
		'WindowPosition'    	= [ordered]@{ 'MainFormX' = '0'; 'MainFormY' = '0'; 'MainFormHeight' = '600'; 'DataGridHeight' = '470' }
		'BossFilter'    	    = [ordered]@{ 'Entropia King' = 'False'; 'Clockworks' = 'False'; 'Royal Knight' = 'False'; 'Solarion' = 'False'; 'C-A01' = 'False'; 'Great Venux Tree' = 'False'; 'Grinch' = 'False'; 'Genesis Entropia King' = 'False'; 'Genesis Clockworks' = 'False'; 'Genesis Royal Knight' = 'False'; 'Genesis Solarion' = 'False'; 'Genesis C-A01' = 'False'; 'Genesis Great Venux Tree' = 'False'; 'Genesis Grinch' = 'False' }
		'Profiles'          	= [ordered]@{}
		...
		'SavedWindowPositions' 	= [ordered]@{}
		'Hotkeys'           	= [ordered]@{}
		'HotkeyGroups'      	= [ordered]@{}
		'LoginConfig'       	= [ordered]@{ 'PostLoginDelay' = '0'; 'Server1Coords' = '0,0'; 'Server2Coords' = '0,0'; 'Channel1Coords' = '0,0'; 'Channel2Coords' = '0,0'; 'FirstNickCoords' = '0,0'; 'ScrollDownCoords' = '0,0'; 'Char1Coords' = '0,0'; 'Char2Coords' = '0,0'; 'Char3Coords' = '0,0'; 'CollectorStartCoords' = '0,0'; 'DisconnectOKCoords' = '0,0'; 'LoginDetailsOKCoords' = '0,0'; 'Client1_Settings' = '1,1,1,No'; 'Client2_Settings' = '1,1,1,No'; 'Client3_Settings' = '1,1,1,No'; 'Client4_Settings' = '1,1,1,No'; 'Client5_Settings' = '1,1,1,No'; 'Client6_Settings' = '1,1,1,No'; 'Client7_Settings' = '1,1,1,No'; 'Client8_Settings' = '1,1,1,No'; 'Client9_Settings' = '1,1,1,No'; 'Client10_Settings' = '1,1,1,No' }
		'Notes'					= [ordered]@{}
		'Ftool'             	= [ordered]@{}
		'Macro'             	= [ordered]@{}
	}
...

	...
	'ini.psm1'             = @{ 
		Priority = 'Critical'; Order = 4; Dependencies = @() 
	...
	'hotkeys.psm1'         = @{ 
		Priority = 'Important'; Order = 5; Dependencies = @() 
	...
	'ui.psm1'              = @{ 
		Priority = 'Critical'; Order = 6; Dependencies = @() 
	...
	'datagrid.psm1'        = @{ 
		Priority = 'Important'; Order = 7; Dependencies = @() 
	...
	'notifications.psm1'   = @{ 
		Priority = 'Important'; Order = 8; Dependencies = @() 
	...
	'runspace-helper.psm1' = @{ 
		Priority = 'Important'; Order = 9; Dependencies = @() 
	...
	'launch.psm1'          = @{ 
		Priority = 'Important'; Order = 10; Dependencies = @() 
	...
	'login.psm1'           = @{ 
		Priority = 'Important'; Order = 11; Dependencies = @() 
	...
	'ftool.psm1'           = @{ 
		Priority = 'Important'; Order = 12; Dependencies = @() 
	...
	'macro.psm1'           = @{ 
		Priority = 'Important'; Order = 13; Dependencies = @() 
		FilePath = (Join-Path $global:DashboardConfig.Paths.Source 'macro.psm1') 
		Base64Content = '

		'
	}
	'reconnect.psm1'       = @{ 
		Priority = 'Important'; Order = 14; Dependencies = @() 
	...
	'extras.psm1'          = @{ 
		Priority = 'Important'; Order = 15; Dependencies = @() 
		FilePath = (Join-Path $global:DashboardConfig.Paths.Source 'extras.psm1') 
		Base64Content = '

		'
	}
	'guide.psm1'           = @{ 
		Priority = 'Optional'; Order = 16; Dependencies = @('ui.psm1') 
		FilePath = (Join-Path $global:DashboardConfig.Paths.Source 'guide.psm1') 
		Base64Content = '

		'
	}
	'wiki.psm1'           = @{ 
		Priority = 'Optional'; Order = 17; Dependencies = @('ui.psm1') 
		FilePath = (Join-Path $global:DashboardConfig.Paths.Source 'wiki.psm1') 
		Base64Content = '
...
function ShowErrorDialog
{
	...
	try
	{
		...
		{
			Show-DarkMessageBox $Message 'Entropia Dashboard Error' 'Ok' 'Error' -TopMost $true | Out-Null
		}
		else
		{
...
function InitializeBaseConfig
{
	...
	try
	{
		...
		[string[]]$directories = @(
			...
			$global:DashboardConfig.Paths.Bosses,
			$logDir
		)
...
function WriteModule
{
	...
	try
	{
		...
		if ($updateNeeded)
		{
			...
			while (([DateTime]::Now - $startTime).TotalMilliseconds -lt $timeoutMilliseconds)
			{
				$attempts++
				try
				{
				...
				catch [System.IO.IOException]
				{
					...
					if (([DateTime]::Now - $startTime).TotalMilliseconds + $retryDelayMilliseconds -ge $timeoutMilliseconds)
					{
...
function ImportModuleUsingReflection
{
	...
	try
	{
		...
		[string]$moduleContent = [System.IO.File]::ReadAllText($Path, [System.Text.Encoding]::UTF8)
		if ($null -eq $moduleContent)
		{
			if (Test-Path -Path $Path -PathType Leaf)
			{
				Write-Verbose "Import-ModuleUsingReflection: Module file '$Path' is empty. Considering import successful (no-op)."
				return $true
			}
			else
			{
				Write-Verbose "Import-ModuleUsingReflection: Failed to read module file '$Path'."
				return $false
			}
		}
		...
		Write-Verbose "Read and stored original content for '$ModuleName'."
...
"@
		...
		Write-Verbose "Creating ScriptBlock and executing modified content globally via Invoke-Command for '$ModuleName'..."
		...
		try
		{
			...
			if (-not $?)
			{
				Write-Verbose "Execution of '$ModuleName' content via Invoke-Command completed, but non-terminating errors occurred (see logs above). This is considered a failure."
				return $false
			}
					
			
			Write-Verbose "Successfully finished executing modified script block for '$ModuleName' via Invoke-Command."
			return $true
		}
		catch
		{
	...
	{
		Write-Verbose "FATAL error during reflection-style import (InvokeCommand) setup for '$ModuleName': $($_.Exception.Message)"
		return $false 
	}
}
...
function Import-DashboardModules
{
	...
	try
	{
		...
		foreach ($entry in $sortedModules)
		{
			...
			$checkFunc = switch ($moduleName) {
				'ui.psm1'       { 'Show-SetupEditor' }
				'hotkeys.psm1'  { 'SetHotkey' }
				'ftool.psm1'    { 'StopFtoolForm' }
				'login.psm1'    { 'LoginSelectedRow' }
				'launch.psm1'   { 'StartClientLaunch' }
				'datagrid.psm1' { 'UpdateDataGrid' }
				'ini.psm1'      { 'ReadConfig' }
				Default         { $null }
			}

			
			if ($checkFunc -and (Get-Command $checkFunc -ErrorAction SilentlyContinue -Verbose:$false)) {
				Write-Verbose "Skipping '$moduleName' - Function '$checkFunc' already loaded."
				continue
			}
			...
			Write-Verbose "Attempting to import PowerShell module '$moduleName' from '$modulePath'..."
				...
				if (-not $importSuccess)
				{
					...
					try
					{
						...
						$importedModule = Import-Module -Name $modulePath -Global -Force -ErrorAction Stop -PassThru 4>$null
						...
						else
						{
							...
							if ($importedModule) { Remove-Module -InputObject $importedModule -Force -ErrorAction SilentlyContinue }
						}
				...
				if (-not $importSuccess)
				{
					...
					if (Get-Command ImportModuleUsingReflection -ErrorAction SilentlyContinue -Verbose:$False)
					{
						...
						try
						{
							...
							if (ImportModuleUsingReflection -Path $modulePath -ModuleName $moduleName -ErrorAction Stop)
							{
								...
								{ 
									$keyFunctionsToCapture = @('SetHotkey', 'ResumeAllHotkeys', 'ResumePausedKeys', 'ResumeHotkeysForOwner', 'RemoveAllHotkeys', 'TestHotkeyConflict', 'InvokeHotkeyAction', 'PauseAllHotkeys', 'PauseHotkeysForOwner', 'UnregisterHotkeyInstance', 'GetVirtualKeyMappings', 'NormalizeKeyString', 'ParseKeyString', 'GetKeyCombinationString', 'IsModifierKeyCode', 'Show-KeyCaptureDialog') 
								}
								elseif ($moduleFileName -in @('ui.psm1', 'ui'))
								{ 
									$keyFunctionsToCapture = @('Show-DarkMessageBox', 'Show-FormAsDialog', 'ShowInputBox', 'ShowSettingsForm', 'HideSettingsForm', 'ShowExtraForm', 'HideExtraForm', 'RefreshLoginProfileSelector', 'RegisterConfiguredHotkeys', 'RefreshNotificationGrid', 'RefreshHotkeysList', 'Update-BossButtonImage', 'Get-RowIdentity', 'GetNeuzResolution', 'SetNeuzResolution', 'SyncProfilesToConfig', 'SyncUIToConfig', 'SyncConfigToUI', 'InitializeUI', 'RegisterUIEventHandlers', 'SetUIElement') 
								}
								elseif ($moduleFileName -in @('datagrid.psm1', 'datagrid'))
								{ 
									$keyFunctionsToCapture = @('Save-WindowPositions','TestValidParameters','Restore-WindowPositions','RestoreWindowStyles','GetProcessList','RemoveTerminatedProcesses','NewRowLookupDictionary','UpdateExistingRow','UpdateRowIndices','AddNewProcessRow','StartWindowStateCheck','FindTargetRow','ClearOldProcessCache','GetProcessProfile','SetWindowToolStyle','UpdateDataGrid','StartDataGridUpdateTimer' ) 
								}
								elseif ($moduleFileName -in @('launch.psm1', 'launch'))
								{ 
									$keyFunctionsToCapture = @('StartClientLaunch','InvokeSavedLaunchSequence','StopClientLaunch') 
								}
								elseif ($moduleFileName -in @('login.psm1', 'login'))
								{ 
									$keyFunctionsToCapture = @('GetClientLogPath','LoginSelectedRow','CleanUpLoginResources') 
								}
								elseif ($moduleFileName -in @('ftool.psm1', 'ftool'))
								{ 
									$keyFunctionsToCapture = @('Invoke-FtoolSpamAction','ToggleSpecificFtoolInstance','ToggleInstanceHotkeys','LoadFtoolSettings','FindOrCreateProfile','InitializeExtensionTracking','GetNextExtensionNumber','FindExtensionKeyByControl','LoadExtensionSettings','UpdateSettings','CreatePositionTimer','RepositionExtensions','CreateSpammerTimer','ToggleButtonState','CheckRateLimit','AddFormCleanupHandler','CleanupInstanceResources','StopFtoolForm','RemoveExtension','FtoolSelectedRow','CreateFtoolForm','AddFtoolEventHandlers','CreateExtensionPanel','AddExtensionEventHandlers') 
								}
								elseif ($moduleFileName -in @('macro.psm1', 'macro'))
								{ 
									$keyFunctionsToCapture = @('InitMacroRunspace','Get-MacroKeyScriptBlock','Invoke-MacroKeyAction','CreateMacroPositionTimer','RepositionSequences','StartMacroSequence','StopMacroSequence','ToggleMacroInstance','ToggleMacroHotkeys','CleanupMacroResources','LoadMacroSettings','UpdateMacroSettings','MacroSelectedRow','StopMacroForm','CreateMacroForm','CreateSequencePanel','AddMacroEventHandlers') 
								}
								elseif ($moduleFileName -in @('reconnect.psm1', 'reconnect'))
								{ 
									$keyFunctionsToCapture = @('InvokeGuardedAction', 'EnsureWindowReady', 'SleepWithCancel', 'EnsureWindowResponsive', 'EnsureWindowState', 'Invoke-MouseClick', 'Invoke-KeyPress', 'ParseCoordinates', 'Wait-ForLogEntry', 'Wait-UntilWorldLoaded', 'Write-LogWithRetry', 'ReportLoginProgress', 'StartDisconnectWatcher', 'StopDisconnectWatcher', 'InvokeReconnectionSequence') 
								}
								...
								elseif ($moduleFileName -in @('extras.psm1', 'extras'))
								{ 
									$keyFunctionsToCapture = @('Stop-WorldBossListener', 'ParseTimeSpanString', 'Invoke-TestButtonAction', 'Send-BossUpdate', 'Send-Message', 'ProcessSpawnEvent', 'Start-WorldBossListener', 'RefreshNoteGrid', 'Show-NoteDialog', 'AddNote', 'EditNote', 'RemoveNote', 'Stop-NoteTimer') 
								}
								elseif ($moduleFileName -in @('guide.psm1', 'guide'))
								{ 
									$keyFunctionsToCapture = @('Show-Guide', 'Close-Guide', 'Show-GuideBubble', 'Switch-GuideContext', 'Resolve-TargetControl', 'Create-BubbleForm', 'Update-BubbleContent', 'Position-BubbleForm') 
								}
								elseif ($moduleFileName -in @('wiki.psm1', 'wiki'))
								{ 
									$keyFunctionsToCapture = @('Show-Wiki') 
								}
								else
								{
								...
								if ($keyFunctionsToCapture.Count -gt 0)
								{
									...
									{
										if (-not (Get-Command -Name $funcName -CommandType Function -ErrorAction SilentlyContinue -Verbose:$False))
										{
				...
				if (-not $importSuccess)
				{
					...
					try
					{
						...
						{
							$invokeContent = [System.IO.File]::ReadAllText($modulePath, [System.Text.Encoding]::UTF8)
						} 
						...
						if ($keyFunctionsToCapture.Count -gt 0)
						{
							...
							foreach ($funcName in $keyFunctionsToCapture)
							{
								$funcInfo = Get-Command -Name $funcName -CommandType Function -ErrorAction SilentlyContinue -Verbose:$False
								if ($funcInfo)
								{
		...
		{
			Write-Verbose "  Successfully written/verified modules:`n$($global:DashboardConfig.LoadedModules.Keys -join ",`n")" 
		}
		if ($failCount -gt 0)
		{
...
function StartDashboard
{
	...
	try
	{
		...
		if (-not (Get-Command InitializeUI -ErrorAction SilentlyContinue -Verbose:$False))
		{
		...
		if ($global:DashboardConfig.Config['Options'] -and $global:DashboardConfig.Config['Options']['GuideSeen'] -eq '0')
		{
			if (Get-Command Show-Guide -ErrorAction SilentlyContinue)
			{
				Write-Verbose '  First run detected. Starting Interactive Guide.'
				Show-Guide
				$global:DashboardConfig.Config['Options']['GuideSeen'] = '1'
		...
		while ($mainForm -and $mainForm.Visible -and -not $mainForm.IsDisposed)
		{
			if ($useNativeLoop)
			{
				...
				try
				{
					...
					$null = $result; $result = [Custom.Native]::AsyncExecution(0, [IntPtr[]]@(), $false, 50, [Custom.Native]::QS_ALLINPUT) 
...
function StopDashboard
{
	...
	if ($global:DashboardConfig.State.IsStopping)
	{
		Write-Verbose 'StopDashboard already in progress. Skipping.'
		return $true
	}
	$global:DashboardConfig.State.IsStopping = $true
	...
	if (Get-Command Stop-NoteTimer -ErrorAction SilentlyContinue -Verbose:$False) { Stop-NoteTimer }
	if (Get-Command Close-Guide -ErrorAction SilentlyContinue -Verbose:$False) { Close-Guide }
	if (Get-Command RemoveAllHotkeys -ErrorAction SilentlyContinue -Verbose:$False) { RemoveAllHotkeys; Write-Verbose 'Hotkeys unregistered.'  }


	
	[bool]$cleanupOverallSuccess = $true

	if (Get-Command RestoreWindowStyles -ErrorAction SilentlyContinue -Verbose:$False) { RestoreWindowStyles } else {	Write-Verbose '  RestoreWindowStyles function not found. Restart Dashboard to enable hidden windows again.'  }

	#region Step 1: Clean Up launch recources
	Write-Verbose 'Step 1: Cleaning up Launch and DataGrid Resources...' 
    
    if ($global:DashboardConfig.Resources.LaunchResources['DataGridUpdater'])
    {
        Write-Verbose '  Stopping DataGridUpdater...'
        try { 
            $dgu = $global:DashboardConfig.Resources.LaunchResources['DataGridUpdater']
            if ($dgu.PowerShell) {
                if ($dgu.PowerShell.InvocationStateInfo.State -eq 'Running') { $dgu.PowerShell.Stop() }
                $dgu.PowerShell.Dispose()
            }
            if ($dgu.Runspace) { $dgu.Runspace.Dispose() }
        } catch { Write-Verbose "  Error stopping DataGridUpdater: $_" }
        $global:DashboardConfig.Resources.LaunchResources.Remove('DataGridUpdater')
    }

    if ($global:DashboardConfig.Resources['WikiResources'])
    {
        Write-Verbose '  Stopping Wiki Background Resources...'
        try {
            $wr = $global:DashboardConfig.Resources['WikiResources']
            if ($wr.PowerShell) {
                try { if ($wr.PowerShell.InvocationStateInfo.State -eq 'Running') { $wr.PowerShell.Stop() } } catch {}
                $wr.PowerShell.Dispose()
            }
            if ($wr.Runspace) { $wr.Runspace.Dispose() }
        } catch { Write-Verbose "  Error stopping WikiResources: $_" }
        $global:DashboardConfig.Resources.Remove('WikiResources')
    }

	if (Get-Command StopClientLaunch -ErrorAction SilentlyContinue -Verbose:$False)
	{
		StopClientLaunch -Sync
	}
	else
	{
	...
	#region Step 1.5: Clean Up Login Resources
	Write-Verbose 'Step 1.5: Cleaning up Login Resources...'
    if ($global:LoginResources)
    {
        try {
            if ($global:LoginResources.PowerShellInstance) {
                if ($global:LoginResources.PowerShellInstance.InvocationStateInfo.State -eq 'Running') {
                    $global:LoginResources.PowerShellInstance.Stop()
                }
                $global:LoginResources.PowerShellInstance.Dispose()
            }
            if ($global:LoginResources.Runspace) { $global:LoginResources.Runspace.Dispose() }
        } catch { Write-Verbose "  Error cleaning up LoginResources: $_" }
        $global:LoginResources = $null
    }
	#endregion Step 1.5: Clean Up Login Resources

	#region Step 2: Clean Up Disconnect Watcher
	Write-Verbose 'Step 2: Cleaning up Disconnect Watcher...' 
	if (Get-Command StopDisconnectWatcher -ErrorAction SilentlyContinue -Verbose:$False)
	{
	...
	#region Step 2.5: Clean Up Active Downloads
	Write-Verbose 'Step 2.5: Cleaning up active downloads...'
    try {
        if ($global:DashboardConfig.Resources.ActiveDownloads) {
            $list = $global:DashboardConfig.Resources.ActiveDownloads
            $downloads = $null
            [System.Threading.Monitor]::Enter($list.SyncRoot)
            try { $downloads = [System.Collections.ArrayList]::new($list) } finally { [System.Threading.Monitor]::Exit($list.SyncRoot) }
            
            foreach ($wc in $downloads) {
	...
	#region Step 3: Clean Up Notification Forms
	Write-Verbose 'Step 3: Cleaning up notification forms...'
	try
	{
		if ($global:LoginNotificationStack -and $global:LoginNotificationStack.Count -gt 0)
		{
			$toastsToClose = [System.Collections.ArrayList]@($global:LoginNotificationStack)
			Write-Verbose "- Found $($toastsToClose.Count) notification form(s) to close."
			foreach ($toast in $toastsToClose)
			{
				if ($toast -and -not $toast.IsDisposed)
				{
	...
	{
		Write-Verbose "Error during notification form cleanup: $($_.Exception.Message)"
		$cleanupOverallSuccess = $false
	}
	#endregion

	#region Step 4: Clean Up Forms (Ftool & Macro)
	Write-Verbose 'Step 4: Cleaning up Tool forms (Ftool/Macro)...' 
	try
	{
		...
		if ($ftoolForms -and $ftoolForms.Count -gt 0)
		{
			...
			Write-Verbose "- Found $($formKeys.Count) form(s) registered. Attempting cleanup..." 
			...
			foreach ($key in $formKeys)
			{
				...
				{
					$formText = try { $form.Text } catch { '(Error getting text)' } 
                    $formType = try { $form.Tag.Type } catch { 'Unknown' }

					Write-Verbose "  - Stopping form '$formText' (Key: $key, Type: $formType)." 
					try
					{
                        if ($formType -eq 'Macro')
                        {
                            if (Get-Command StopMacroForm -ErrorAction SilentlyContinue) {
                                StopMacroForm -Form $form
                            } else {
                                $form.Close()
                            }
                        }
                        ...
                        {
						    if (Get-Command StopFtoolForm -ErrorAction SilentlyContinue) {
					...
					{
						Write-Verbose "  - Error during Stop function for form '$formText': $($_.Exception.Message)" 
						$cleanupOverallSuccess = $false
					}
					finally 
					{
			...
			Write-Verbose '- Finished form cleanup.' 
		}
		else
		{
			Write-Verbose '  No active forms found in configuration to clean up.'  
		}
	}
	catch 
	{
		Write-Verbose "Error during form cleanup phase setup: $($_.Exception.Message)" 
		$cleanupOverallSuccess = $false
	}
	#endregion 
			
	#region Step 5: Clean Up Application Timers
	Write-Verbose 'Step 5: Cleaning up application timers...' 
	try
	{
	...
	#region Step 5.5: Clean Up Settings & Extra Forms
	Write-Verbose 'Step 5.5: Cleaning up Settings/Extra forms...'
	try
	{
		if ($global:DashboardConfig.UI.SettingsForm -and -not $global:DashboardConfig.UI.SettingsForm.IsDisposed)
		{
			Write-Verbose '  - Disposing SettingsForm...'
			$global:DashboardConfig.UI.SettingsForm.Dispose()
		}
		if ($global:DashboardConfig.UI.ExtraForm -and -not $global:DashboardConfig.UI.ExtraForm.IsDisposed)
		{
			Write-Verbose '  - Disposing ExtraForm...'
			$global:DashboardConfig.UI.ExtraForm.Dispose()
		}
        if ($global:DashboardConfig.Resources.WikiForm -and -not $global:DashboardConfig.Resources.WikiForm.IsDisposed)
        {
            Write-Verbose '  - Disposing WikiForm...'
            $global:DashboardConfig.Resources.WikiForm.Dispose()
        }
	}
	catch
	{
		Write-Verbose "Error during Settings/Extra form cleanup: $($_.Exception.Message)"
	}
	#endregion

	#region Step 6: Clean Up Main UI Form
	Write-Verbose 'Step 6: Cleaning up main UI form...' 
	try
	{
	...
	#region Step 7: Reset Application State Flags
	Write-Verbose 'Step 7: Resetting application state flags...' 
	try
	{
...
try
{
	...
	& $updateSplash 'Loading core modules' 30
	...
	Write-Verbose '--- Step 3.5: Checking for script updates ---' 
	& $updateSplash 'Checking for updates' 40
	try
	{
		...
		else
		{
			...
			if ($executablePath -match '\.exe$')
			{
				try
				{
					$vi = [System.Diagnostics.FileVersionInfo]::GetVersionInfo($executablePath)
					if (-not [string]::IsNullOrWhiteSpace($vi.FileVersion)) { $localVersion = $vi.FileVersion }
				}
				catch {}
			}

			if ($localVersion -eq '0.0')
			{
			...
			try
			{
				$remoteContent = (Invoke-WebRequest -Uri $remoteUrl -UseBasicParsing -ErrorAction Stop -Verbose:$false).Content
			}
			catch
			{
				...
				if ($rm.Success)
				{
					...
					try
					{
						if ([version]$localVersion -lt [version]$remoteVersion)
						{
							...
							$resp = Show-DarkMessageBox -Owner $splashForm -Text $promptMsg -Caption $caption -Buttons 'YesNo' -Icon 'Information' -TopMost $true
							...
							if ($resp -eq [System.Windows.Forms.DialogResult]::Yes)
							{
								...
								catch
								{
									...
									Show-DarkMessageBox -Owner $splashForm -Text $errMsg -Caption 'Update Failed' -Buttons 'Ok' -Icon 'Error' -TopMost $true
...
"@
								...
								Show-DarkMessageBox -Owner $splashForm -Text "Update successfully downloaded!`nRestarting now." -Caption 'Update Complete' -Buttons 'Ok' -Icon 'Information' -Type 'success' -TopMost $true
	...
	& $updateSplash 'Loading saved settings' 60
	if (Get-Command InitializeIniConfig -ErrorAction SilentlyContinue -Verbose:$False)
	{
		try
		{
	...
	& $updateSplash 'Building user interface' 80
	...
	if (Get-Command StartDataGridUpdateTimer -ErrorAction SilentlyContinue -Verbose:$False)
	{
	...
	if (Get-Command StartDisconnectWatcher -ErrorAction SilentlyContinue -Verbose:$False)
	{
...
finally
{
	...
	if ($splashForm -and -not $splashForm.IsDisposed) { $splashForm.Dispose() }
	if (Get-Command StopDashboard -ErrorAction SilentlyContinue -Verbose:$False)
	{
		$null = $cleanupStatus; $cleanupStatus = StopDashboard
	}
	else
	{
	...
	if ($global:LogWriter) { try { $global:LogWriter.Dispose() } catch {}; $global:LogWriter = $null }

    if ($global:DashboardConfig.State.IsRunningAsExe)
    {
        Write-Verbose 'Forcefully terminating process (EXE mode)...'
